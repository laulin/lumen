...
def run_benchmark():
    ...
    with Window("Benchmark", width, height) as win:
        ...
        while running:
            ...
            if abs(diff) > 0.5:
                ...
                # For benchmark, let's just move directly to ensure we hit new content
            ...
            # Pump events to prevent OS freeze warnings (but don't process them)
            sdl2.ext.get_events()
