...
def benchmark():
    ...
    print(f"Benchmarking {count} rectangles...")
    ...
    # Force present to ensure commands flushed (though software is immediate usually)
    renderer.present()
    end = time.time()
    old_time = end - start
    ...
    # 2. AA (New Method)
    # Define the function inline or import? Import is better but we need the method.
    # I'll implement the function here to isolate the benchmark from Window overhead 
    # and measure purely drawing cost.
    ...
    if new_time > 0:
        ...
        print("Too fast to measure overhead")
